...
ui <- page_386(
    ...
    fluidRow(
        column(
            width = 9,
            jumbotron_386(leafletOutput("busmap")),
            br(),
            br(),
            card_386(uiOutput("numVehiclesTable"))
        ),
        column(
            width = 3,
            card_386(
                ...
                button_386("zoomButton", "Zoom to fit buses", class = "btn-lg")
            ),
            card_386(
                status = "warning",
                select_input_386(
                ...
                button_386("refresh", "Refresh now", class = "btn-lg"),
                p(
                    class = "text-muted",
                    br(),
